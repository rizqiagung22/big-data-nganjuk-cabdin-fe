<template>
  ...
  <div
      v-else-if="authStore.isAuthenticated && authStore.user && authStore.user?.role === 'user'"
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md m-4 transform transition-all text-center p-6 sm:p-8">
          ...
          <div class="mt-4">
            ...
            <p class="mt-2 text-sm text-gray-600">
              Maaf, Anda tidak memiliki izin yang cukup untuk mengakses halaman ini. Silakan hubungi administrator jika
...
onMounted(async () => {
  ...
  if (authToken && !authStore.isAuthenticated) {
    try {
      ...
      await authStore.updateToken(authToken);
